<HTML>
	<HEAD>
		...
		<SCRIPT SRC="/theme/js/message.js" TYPE="text/javascript"></SCRIPT>
		...
		<DIV ID="wrap">
			...
			<DIV ID="banner-nav">
				<UL ID="bannernav">
					...
					<LI id="bannernav-projects"><A 
HREF="http://projects.fourisland.com"><B><SPAN>Projects</SPAN></B></A></LI>
					...
					<LI id="bannernav-<!--LOWERLOGDATA-->"><A HREF="/<!--LOWERLOGDATA-->.php?redirect=<!--REDIRPAGE-->"><B><SPAN><!--LOGDATA--></SPAN></B></A></LI>
					<!--BEGIN PANEL-->
