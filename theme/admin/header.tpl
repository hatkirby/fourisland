				...
				<div id="container">
					<div id="sidebar">
						<ul class="sideNav">
							...
							<!--BEGIN POLLSISACTIVECAT-->
							<li><a href="/admin/newPoll.php"<!--NEWPOLLACTIVE-->>Write a new poll</a></li>
							<li><a href="/admin/polls.php"<!--POLLSACTIVE-->>Manage Polls</a></li>
							<!--END POLLSISACTIVECAT-->
