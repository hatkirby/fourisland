...
AudioPlayer.setup("http://fourisland.com/theme/js/audio-player/player.swf", {  
	...
	<BODY ID="<!--BODYID-->" CLASS="<!--CATEGORY--> <!--AID--> <!--CATEGORY-->-<!--AID-->"<!--BODYTAGS-->>
		...
		<DIV ID="wrap">
			...
			<DIV id="page-body">
				...
				<DIV ID="rightbar">
					...
					<DIV class="sidebar module rounded">
						...
						<P>
							<!--BEGIN TAGCLOUD-->
							<A HREF="/blog/tag/<!--TAGCLOUD.TAG-->.php" STYLE="font-size: <!--TAGCLOUD.SIZE-->pt" TITLE="<!--TAGCLOUD.TAG--> (<!--TAGCLOUD.COUNT-->)"><!--TAGCLOUD.TAG--></A>
							<!--END TAGCLOUD-->
						</P>
					</DIV>
			...
			<DIV ID="footer">
				<UL CLASS="rows">
					<LI>Four Island (<a href="http://code.fourisland.com/fourisland/">r<!--REVISION--></a>) is by <a href="http://fourisland.com">Starla Insigna</a></LI>
