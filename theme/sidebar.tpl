				<DIV ID="rightbar">
							...
							<DIV CLASS="rounded">
								<BLOCKQUOTE>
									<DIV ID="hatnav">
										...
										<UL>
											<!--BEGIN HATNAV-->
											<LI STYLE="margin-left: 10"><A ID="<!--HATNAV.AID-->" HREF="<!--HATNAV.HREF-->"><IMG SRC="<!--HATNAV.IMAGE-->" ALT="<!--HATNAV.TEXT-->"><!--HATNAV.TEXT--><!--HATNAV.NEW--></A></LI>
											<!--END HATNAV-->
										</UL>
									</DIV>
								</BLOCKQUOTE>
					...
					<DIV class="sidebar">
						<DIV CLASS="bubble">
							<DIV CLASS="rounded">
								<BLOCKQUOTE>
									<DIV CLASS="hatbar"><H3>Poll of the Week</H3>
					...
					<DIV class="sidebar">
						<DIV CLASS="bubble">
							<DIV CLASS="rounded">
								<BLOCKQUOTE>
									<DIV CLASS="hatbar"><H3>Hatbar</H3><P>
										<P>
											<SPAN ID="hitcounter">
												Hits: <!--HITS--><BR>
												Today: <!--TODAY-->
