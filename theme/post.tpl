...
<DIV CLASS="post vevent" ID="post-<!--POST.ID-->">
	...
	<DIV CLASS="post-title">
		<H2>
			<!--BEGIN EXTERNAL--><A CLASS="url" HREF="/blog/<!--POST.CODED-->/" REL="bookmark" TITLE="Permalink for <!--POST.TITLE-->"><!--END EXTERNAL-->
			<SPAN CLASS="summary"><!--POST.TITLE--></SPAN>
			<!--BEGIN EXTERNAL--></A><!--END EXTERNAL-->
		</H2>
